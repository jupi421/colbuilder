...
def read_crosslink(pdb_file: Union[str, Path]) -> List[Crosslink]:
    ...
    with open(pdb_path, 'r') as f:
        for line in f:
            if ((line[17:20] == 'LYX' and line[13:16] == 'C13') or
                (line[17:20] == 'LY3' and line[13:15] == 'CG') or
                (line[17:20] == 'LY2' and line[13:15] == 'CB')):
            ...
            elif ((line[17:20] == 'L4Y' and line[13:15] == 'CE') or
                  (line[17:20] == 'L5Y' and line[13:15] == 'NZ')):
                crosslinks.append(Crosslink(
                    resid=line[22:26].strip(),
                    resname=line[17:20],
                    chain=line[21],
